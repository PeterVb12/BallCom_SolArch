...
using BallCom.CustomerService.API.Models.Commands;
...
namespace BallCom.CustomerService.API.Controllers
{
    ...
    public class TicketsController : ControllerBase
    {
        ...
        public TicketsController(CustomerServiceDbContext context, ILogger<TicketsController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> Register([FromBody] RegisterTicketCommand command)
        {
            ...
            await EnsureCustomerExistsAsync(command.CustomerEmail.Trim());
            ...
            _logger.LogInformation("[Customer Service] Ticket {TicketId} geregistreerd voor {Email}.", ticketId, ticket.CustomerEmail);
        ...
        public async Task<IActionResult> Answer(Guid id, [FromBody] AnswerTicketCommand command)
        {
            ...
            _logger.LogInformation("[Customer Service] Ticket {TicketId} beantwoord door {Employee}.", id, command.AnsweredBy);
        ...
        private async Task EnsureCustomerExistsAsync(string email)
        {
